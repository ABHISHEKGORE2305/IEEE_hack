                    ...
                    <div className='bg-slate-100  h-60 rounded-2xl m-3 p-1 translate-y-15  '>
                        ...
                        <div className='flex'>
                            <div className='bg-white w-xl h-45 rounded-2xl p-2 m-3'>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='h-full aspect-square' fill="cyan"><path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM7 12C7 14.7614 9.23858 17 12 17C14.7614 17 17 14.7614 17 12H15C15 13.6569 13.6569 15 12 15C10.3431 15 9 13.6569 9 12H7Z"></path></svg>
                                </div>
                            ...
                            <div className='bg-white w-xl h-45 rounded-2xl p-2 m-3'>
                                <div className='h-1/2 w-full flex justify-center'>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="yellow"><path d="M12 14V22H4C4 17.5817 7.58172 14 12 14ZM18 21.5L15.0611 23.0451L15.6224 19.7725L13.2447 17.4549L16.5305 16.9775L18 14L19.4695 16.9775L22.7553 17.4549L20.3776 19.7725L20.9389 23.0451L18 21.5ZM12 13C8.685 13 6 10.315 6 7C6 3.685 8.685 1 12 1C15.315 1 18 3.685 18 7C18 10.315 15.315 13 12 13Z"></path></svg>
                                </div>
