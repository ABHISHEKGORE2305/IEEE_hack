            ...
            <div className='flex flex-row h-screen bg-slate-100'>
                <div className='overflow-y-scroll basis-190 no-scrollbar'>
                    <div className='bg-white rounded-2xl m-3 h-35 translate-y-15 p-6'>
                        <h1 className='text-3xl font-bold'>Good Morning, <span className='text-amber-400'>Dr. {doctor.name}</span></h1>
                        <p className='text-bold text-zinc-500 text-xl mt-2'>Have a nice day at work !!!</p>
                    </div>
                    ...
                    <div className='h-2/3 rounded-2xl m-3 p-2 translate-y-15 bg-slate-100'>
                        <h1 className='text-xl font-bold text-zinc-500 mb-3'>Your upcoming Appointments</h1>
